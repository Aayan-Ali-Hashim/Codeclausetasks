...
text = st.ScrolledText(root,font='classic-roman',undo=True,background='#abdbe3')
...
message = " AAYAN ALI CODECLAUSE "
label = tk.Label(root, text=message,font="Bold",background='#a64d79')
label.pack()
animate_text()
